          ...
          <div className="container mx-auto pb-10">
            <div className="glass-strong rounded-2xl p-6 max-w-3xl text-white">
              ...
              <p className="mt-3 text-white/80">
                Located in Kochi, India, we offer comprehensive maritime
                education with modern facilities and experienced faculty across
                shipping, logistics, and marine disciplines.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto py-12 grid gap-6 md:grid-cols-2">
        ...
        <div className="glass rounded-2xl p-6">
          ...
          <p className="mt-2 text-sm text-foreground/80">
            We prepare cadets for a global maritime career through a blend of
            theoretical knowledge, practical training, and strict adherence to
