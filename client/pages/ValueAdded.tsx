    ...
    <main>
          ...
          <div className="container mx-auto pb-10">
            <div className="glass-strong rounded-2xl p-6 max-w-2xl text-white">
              ...
              <p className="mt-3 text-white/80">
                Course categories include Offshore Oil Field,
                Passenger/Cruise/Yacht, Inland & Main Fleet, Project Skilled,
                and Management.
              </p>
            </div>
          </div>
      ...
      <section className="container mx-auto py-12 grid gap-6 md:grid-cols-2">
        <Card
          ...
          desc="Safety, survival and equipment handling aligned with offshore standards."
        />
        <Card
          title="Passenger / Cruise / Yacht"
          desc="Hospitality, emergency procedures, and international etiquette modules."
        />
        <Card
          title="Inland – Near Coastal – Main Fleet"
          desc="Deck & engine fundamentals, navigation, ISM/ISPS, and simulator assessments."
        />
        <Card
          title="Project Skilled"
          desc="Rigging & slinging, welding basics, scaffolding safety, LOTO, PTW, and JSA."
        />
        <Card
          title="Management"
          desc="Leadership, audit readiness, incident investigation, and voyage planning."
        />
      </section>
    </main>
  );
